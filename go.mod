...
// `go get ...@latest` (highest semver wins) to a stale commit. The tag is
// deleted from the remote; this retract tells module clients to ignore the
// copy the module proxy has permanently cached (gibson-executor#14).
retract v1.0.0
